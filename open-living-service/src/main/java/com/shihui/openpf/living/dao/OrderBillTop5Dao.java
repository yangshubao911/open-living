...
public class OrderBillTop5Dao extends AbstractDao<OrderBillTop5> {
	public List<OrderBillTop5> query(long userId, int count) {
		...
		sql.append("SELECT a.order_id, a.user_id, a.gid AS group_id, a.mid, a.service_id, a.goods_id, a.goods_version, b.category_id, b.fee_name, b.city_id, b.company_id, c.company_no, b.bill_key, b.bill_key_type ");
